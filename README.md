...
MacTreeSize checks the latest GitHub Release at `https://api.github.com/repos/Soulveig/MacTreeSize/releases/latest` for updates. Release assets should use the `MacTreeSize-<version>.zip` naming format.
